                      ...
                      <div class="col-md-55">
                        <div class="thumbnail">
                          <div class="image view view-first"  onclick="(window.location='e_commerce.php?id=0')" style="cursor:pointer; display: flex;flex-direction: column ;align-items:center;">
                            <img style="height: 100%;display: block;" src="images/0.png" alt="image" />
                            <div class="mask">
                          ...
                          <div class="caption" style="text-align:center ;">
                            <p>Camisa de Chainsaw man <b>R$ 33,00</b></p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-55">
                        <div class="thumbnail">
                          <div class="image view view-first"  onclick="(window.location='e_commerce.php?id=1')" style="cursor:pointer; display: flex;flex-direction: column ;align-items:center;">
                            <img style="height: 100%; display: block;" src="images/1.png" alt="image" />
                            <div class="mask">
                          ...
                          <div class="caption" style="text-align:center ;">
                            <p>Camisa do Terceiro Hokage <b>R$ 34,00</b></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-55">
                        <div class="thumbnail">
                           <div class="image view view-first"  onclick="(window.location='e_commerce.php?id=2')" style="cursor:pointer; display: flex;flex-direction: column ;align-items:center;">
                            <img style="height: 100%; display: block;" src="images/2.png" alt="image" />
                            <div class="mask">
                          ...
                          <div class="caption" style="text-align:center ;">
                            <p>Camisa do Escanor <b>R$ 35,00</b></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-55">
                        <div class="thumbnail">
                           <div class="image view view-first"  onclick="(window.location='e_commerce.php?id=3')" style="cursor:pointer; display: flex;flex-direction: column ;align-items:center;">
                            <img style="height: 100%; display: block;" src="images/3.png" alt="image" />
                            <div class="mask">
                          ...
                          <div class="caption" style="text-align:center ;">
                            <p>Camisa do Itachi <b>R$ 36,00</b></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-55">
                        <div class="thumbnail">
                           <div class="image view view-first"  onclick="(window.location='e_commerce.php?id=4')" style="cursor:pointer; display: flex;flex-direction: column ;align-items:center;">
                            <img style="height: 100%; display: block;" src="images/4.png" alt="image" />
                            <div class="mask">
                          ...
                          <div class="caption" style="text-align:center ;">
                            <p>Camisa do Minato <b>R$ 39,00</b></p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-55">
                        <div class="thumbnail">
                           <div class="image view view-first"  onclick="(window.location='e_commerce.php?id=5')" style="cursor:pointer; display: flex;flex-direction: column ;align-items:center;">
                            <img style="height: 100%; display: block;" src="images/5.png" alt="image" />
                            <div class="mask no-caption">
                              
                            </div>
                          </div>
                          <div class="caption" style="text-align:center ;">
                            <p>Moletom do Tobi <b>R$ 27,00</b></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-55">
                        <div class="thumbnail">
                           <div class="image view view-first"  onclick="(window.location='e_commerce.php?id=6')" style="cursor:pointer; display: flex;flex-direction: column ;align-items:center;">
                            <img style="height: 100%; display: block;" src="images/6.png" alt="image" />
                            <div class="mask no-caption">
                              
                            </div>
                          </div>
                          <div class="caption" style="text-align:center ;">
                            <p>Camisa do Obito <b>R$ 26,00</b></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-55">
                        <div class="thumbnail">
                          ...
                          <div class="caption" style="text-align:center ;">
                            <p>Camisa do Luffy <b>R$ 28,00</b></p>
                          </div>
                        </div>
                      </div>
